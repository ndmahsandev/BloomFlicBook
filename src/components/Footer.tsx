                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-24">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        <Link href="/" className="inline-flex items-center space-x-2 group">
                            ...
                            <span className="text-2xl font-bold text-white tracking-tight italic">FlipFlow</span>
                        </Link>
                        <p className="max-w-md text-lg text-gray-400 font-medium leading-relaxed italic">
                            Empowering publishers to create the worlds most immersive
                            digital reading experiences.
                        </p>
                        <div className="flex items-center space-x-5">
                            <Link href="#" className="p-3 bg-white/5 rounded-2xl hover:bg-primary-500/20 hover:text-primary-400 transition-all text-gray-500">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <h4 className="text-sm font-bold tracking-widest uppercase text-white">Product</h4>
                        <ul className="space-y-4 text-gray-400 font-medium">
                            ...
                            <li><Link href="#" className="hover:text-primary-400 transition-colors">Custom Solutions</Link></li>
                        </ul>
                    </div>

                    <div className="lg:col-span-2 space-y-6">
                        <h4 className="text-sm font-bold tracking-widest uppercase text-white">Company</h4>
                        <ul className="space-y-4 text-gray-400 font-medium">
                            ...
                            <li><Link href="#" className="hover:text-primary-400 transition-colors">Legal</Link></li>
                        </ul>
                    </div>

                    <div className="lg:col-span-3 space-y-6">
                        <h4 className="text-sm font-bold tracking-widest uppercase text-white">Get in touch</h4>
                        <p className="text-gray-400 font-medium pr-4">Subscribe to our newsletter for the latest digital publishing insights.</p>
                        <div className="flex p-1.5 bg-white/5 border border-white/10 rounded-2xl">
                            ...
                            />
                            <button className="px-5 py-2.5 bg-white text-black text-sm font-bold rounded-xl hover:bg-gray-200 transition-colors">Join</button>
                        </div>
                    </div>
                </div>

                <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-gray-500 font-medium text-sm gap-4">
